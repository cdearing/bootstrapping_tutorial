...
'''
1) The methodology in the bootstrapping source code used in Fig 4.3 calculates standard deviations
and only needs one set of data, while the methodology use in Fig 3.24 calculates correlation coefficients
which is a measurement of how much two sets of data are correlated and therefore requires two sets of data.
This is why it is not possible to use astroML.resample.bootstrap in the Fig 3.24 code.

2) The Fig 3.24 code requires a loop because it bootstrapping the calculation of the correlation coefficient
for two sets of data and therefore has to loop through more data.
